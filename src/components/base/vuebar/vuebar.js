  ...
  Vuebar.install = function (Vue, installOptions) {
    ...
    function documentMouseup(el) {
      ...
      return function (event) {
        ...
        state.draggingPhantomClassTimeout = setTimeout(() => {
    ...
    function initScrollbar(el, kwargs) {
      ...
      var options = kwargs.value ? kwargs.value : kwargs || {};
    ...
    function detectBrowser() {
      ...
      // safari
      var safari =
        !!window.safari || (ua.toLowerCase().indexOf('safari') > -1 && vendor.toLowerCase().indexOf('apple') > -1);
